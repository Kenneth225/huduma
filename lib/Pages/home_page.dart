        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              showSearch(context: context, delegate: FoodSearch(searchBloc: searchBloc));
            },
          ),
          PopupOptionMenu(),
        ],
...
class PopupOptionMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return PopupMenuButton<MenuOption>(
      color: Colors.white,
      itemBuilder:
          (context) => <PopupMenuEntry<MenuOption>>[
            PopupMenuItem(
              child: Text("Plat Africain"),
              value: MenuOption.Africain,
            ),
            PopupMenuItem(
              child: Text("Plat Asiatique"),
              value: MenuOption.Asiatique,
            ),
            PopupMenuItem(
              child: Text("Plat Européen"),
              value: MenuOption.Europeen,
            ),
            PopupMenuItem(
              child: Text("Fromage/Wangachi"),
              value: MenuOption.Fromage,
            ),
      ...
      onSelected: (value) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => Repasdet(alimnts: value.toString().substring(11)),
          ),
        );
      },
    );
